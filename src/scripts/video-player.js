...
window.openVideo = function(videoUrl, videoTitle) {
...
window.imgFallback = function(img, text) {
  ...
  modal.innerHTML = `
    <div class="video-modal-inner coming-soon-modal">
      ...
      <div class="coming-soon-content">
        ...
        <a href="/demo" class="btn btn-demo btn-lg" onclick="closeVideo()">Solicitar demostración gratuita →</a>
      </div>
    </div>
  `;
  modal.addEventListener('click', function(e) {
